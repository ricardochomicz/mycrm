        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-2" wire:ignore>
                    <x-select :options="$operators" title="Operadoras" id="sel2" wire:model.live="filters.operator" />
                </div>
                <div class="form-group col-sm-2" wire:ignore>
                    <x-select :options="$categories" title="Categorias" id="sel3" wire:model.live="filters.category" />
                </div>
                <div class="form-group col-sm-2" wire:ignore>
