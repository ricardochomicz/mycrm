    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-3" wire:ignore>
                    <x-select :options="$operators" title="Operadora" id="sel2" wire:model.live="filters.operator" />
                </div>
                <div class="form-group col-sm-3" wire:ignore>
                    <x-select :options="$types" title="Tipo Pedido" id="sel3" wire:model.live="filters.type" />
                </div>
